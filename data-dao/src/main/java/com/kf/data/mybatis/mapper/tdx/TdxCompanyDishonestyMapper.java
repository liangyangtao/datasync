...
public interface TdxCompanyDishonestyMapper {
     ...
     * @mbggenerated Fri Mar 16 15:31:48 CST 2018
     */
    int updateByExampleSelective(@Param("record") TdxCompanyDishonestyWithBLOBs record, @Param("example") TdxCompanyDishonestyExample example);
     ...
     * @mbggenerated Fri Mar 16 15:31:48 CST 2018
     */
    int updateByExampleWithBLOBs(@Param("record") TdxCompanyDishonestyWithBLOBs record, @Param("example") TdxCompanyDishonestyExample example);
     ...
     * @mbggenerated Fri Mar 16 15:31:48 CST 2018
     */
    int updateByExample(@Param("record") TdxCompanyDishonesty record, @Param("example") TdxCompanyDishonestyExample example);
