...
public interface NeeqCompanyOnlineMapper {
	 ...
	 * @mbggenerated  Mon Mar 19 09:59:49 CST 2018
	 */
	int updateByExampleSelective(@Param("record") NeeqCompanyOnline record,
			@Param("example") NeeqCompanyOnlineExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table neeq_company
	 * @mbggenerated  Mon Mar 19 09:59:49 CST 2018
	 */
	int updateByExampleWithBLOBs(@Param("record") NeeqCompanyOnline record,
			@Param("example") NeeqCompanyOnlineExample example);
